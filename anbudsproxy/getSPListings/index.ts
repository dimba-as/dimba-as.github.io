...
const getSPListings: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    ...
    const results2 = await sp.search(<ISearchQuery>{
        ...
        RowLimit: 10,
        SelectProperties:["Title","avCustomFag","avCustomAnbudsbeskrivelse","avPublisert","avPubliseringsniva"],
